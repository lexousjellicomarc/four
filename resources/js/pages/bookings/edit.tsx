...
function inferBlocks(from?: string | null, to?: string | null): BlockKey[] {
    ...
    if (start === '12:00' && (end === '23:59' || end === '00:00'))
        return ['PM', 'EVE'];
    if (start === '06:00' && (end === '23:59' || end === '00:00'))
        return ['AM', 'PM', 'EVE'];
    return [];
}
...
function fieldWrap(hasError?: string) {
    return hasError
        ? 'rounded-xl border border-red-300 bg-red-50/60 p-3 dark:border-red-900/60 dark:bg-red-950/20'
        : '';
}
...
export default function EditBooking() {
    ...
    const [selectedDate, setSelectedDate] = useState(() =>
        datePart(booking.booking_date_from),
    );
    const [selectedBlocks, setSelectedBlocks] = useState<BlockKey[]>(() =>
        inferBlocks(booking.booking_date_from, booking.booking_date_to),
    );
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            This version adds a clearer progress panel and audit
                            sidebar while preserving the fixed reload/edit flow.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className={statusPill(booking.payment_status)}>
                            {booking.payment_status ?? 'unpaid'}
                        </span>
                ...
                >
                    <div className="space-y-6">
                        <Card>
                            ...
                            <CardContent className="grid gap-4 md:grid-cols-2">
                                <div
                                    ...
                                    className={fieldWrap(errors.client_name)}
                                >
                                ...
                                <div
                                    ...
                                    className={fieldWrap(errors.company_name)}
                                >
                                ...
                                <div
                                    data-field="client_contact_number"
                                    className={fieldWrap(
                                        errors.client_contact_number,
                                    )}
                                >
                                    <Label htmlFor="client_contact_number">
                                        Contact number *
                                    </Label>
                                    <Input
                                    ...
                                    />
                                    <ScrollError
                                        message={errors.client_contact_number}
                                    />
                                </div>

                                <div
                                    data-field="client_email"
                                    className={fieldWrap(errors.client_email)}
                                >
                                ...
                                <div
                                    data-field="head_of_organization"
                                    className={fieldWrap(
                                        errors.head_of_organization,
                                    )}
                                >
                                    <Label htmlFor="head_of_organization">
                                    ...
                                    />
                                    <ScrollError
                                        message={errors.head_of_organization}
                                    />
                                </div>

                                <div
                                    data-field="number_of_guests"
                                    className={fieldWrap(
                                ...
                                >
                                    ...
                                    />
                                    <ScrollError
                                        message={errors.number_of_guests}
                                    />
                                </div>

                                <div
                                    data-field="type_of_event"
                                    className={cn(
                                        'md:col-span-2',
                                        fieldWrap(errors.type_of_event),
                                    )}
                                >
                                ...
                                <div
                                    ...
                                    className={cn(
                                        'md:col-span-2',
                                        fieldWrap(errors.client_address),
                                    )}
                                >
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                >
                                    ...
                                    />
                                    <ScrollError
                                        message={errors.booking_date_from}
                                    />
                                </div>

                                <div className="grid gap-3 md:grid-cols-3">
                                    {(['AM', 'PM', 'EVE'] as BlockKey[]).map(
                                        (block) => {
                                            const isSelected =
                                ...
                                <div className="rounded-2xl border bg-muted/30 p-4 text-sm">
                                    ...
                                    {!canEditAll && (
                                        <p className="mt-2 text-xs text-muted-foreground">
                                            Clients can update details and
                                            survey proof here, but the schedule
                                            remains staff-controlled.
                                        </p>
                                    )}
                                </div>
                            </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent className="grid gap-4 md:grid-cols-2">
                                <div
                                    data-field="survey_email"
                                    className={fieldWrap(errors.survey_email)}
                                >
                                    ...
                                    />
                                    <ScrollError
                                        message={errors.survey_email}
                                    />
                                </div>

                                <div
                                    data-field="survey_proof_image"
                                    className={fieldWrap(
                                        errors.survey_proof_image,
                                    )}
                                >
                                    <Label htmlFor="survey_proof_image">
                                    ...
                                    />
                                    <ScrollError
                                        message={errors.survey_proof_image}
                                    />
                                </div>
                                ...
                                <div className="grid gap-4 md:col-span-2 md:grid-cols-2">
                                    ...
                                    <div className="rounded-2xl border bg-muted/20 p-4">
                                        ...
                                        {previewUrl ? (
                                            ...
                                            <div className="rounded-xl border border-dashed px-4 py-10 text-sm text-muted-foreground">
                                                Select a new file to preview it
                                                here.
                                            </div>
                                        )}
                                    </div>
                            ...
                            <CardContent className="space-y-3">
                                {selectedItems.length > 0 ? (
                                    selectedItems.map((item, index) => (
                                        <div
                                            key={`${item.service_id ?? 'item'}-${index}`}
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div
                                    ...
                                    className={fieldWrap(errors.booking_status)}
                                >
                                    ...
                                    <ScrollError
                                        message={errors.booking_status}
                                    />
                                </div>

                                <div
                                    data-field="payment_status"
                                    className={fieldWrap(errors.payment_status)}
                                >
