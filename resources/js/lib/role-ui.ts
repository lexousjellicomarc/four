import {
  ...
  import { getPrimaryRole, getRoleWorkspace, type RoleKey } from '@/lib/role-workspaces';
  ...
  export function getRoleTone(role: RoleKey): RoleTone {
    ...
    return {
      ...
      shellClass: 'bg-stone-50 text-stone-950 dark:bg-stone-950 dark:text-stone-50',
      sidebarClass:
      ...
      return [
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: '/admin/content',
              icon: Home,
              description: 'Homepage, events, facilities, tourism office, contact, and guidelines.',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              icon: CalendarDays,
              permission: 'dashboard.view',
              description: 'Bookings, public events, and blocked dates.',
            },
            {
              ...
              permission: 'dashboard.view',
              description: 'Block dates and manage unavailable schedules.',
            },
            {
              title: 'Bookings',
              href: '/admin/bookings',
            ...
            },
            {
              ...
              description: 'Payment compliance and settlement checks.',
            },
          ],
        },
        {
  ...
  export function isHrefActive(currentUrl: string, href: NavItem['href']): boolean {
  ...
  export function hasNavPermission(item: NavItem, permissions?: string[] | null): boolean {
    if (!item.permission) {
      return true;
    }
