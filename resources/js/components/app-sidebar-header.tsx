...
export function AppSidebarHeader({ breadcrumbs = [] }: { breadcrumbs?: BreadcrumbItem[] }) {
    ...
    return (
        <>
            <header className="backend-topbar backend-main-topbar sticky top-0 z-[70] border-b border-[#d9c7a6]/60 bg-[#fffaf0]/88 shadow-[0_14px_50px_rgba(47,37,23,0.08)] backdrop-blur-2xl dark:border-white/10 dark:bg-[#101419]/84">
