    ...
    <article className="overflow-hidden rounded-[2rem] border border-black/5 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/5">
      ...
      <div className="space-y-3 p-6">
        ...
        <p className="text-sm leading-7 text-slate-500 dark:text-slate-400">
          {item.note || 'Public event details remain subject to final operational confirmation.'}
        </p>
      </div>
    </article>
  );
  ...
  return (
    <section className="rounded-[2.2rem] border border-black/5 bg-white/86 p-5 shadow-[0_24px_70px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/5 sm:p-6 lg:p-7">
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <EventCarouselCard item={active} badge={badge} />
    ...
    <section className="mt-14 w-full px-4 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-[1600px] space-y-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl dark:text-white">
              BCCC events in one carousel, Baguio City highlights in another.
            </h2>
          </div>
        ...
        <EventCarouselSection
          title="BCCC public events in a centered carousel layout"
          eyebrow="BCCC Events"
          items={bcccEvents}
          badge="BCCC Event"
        ...
        <EventCarouselSection
          title="Baguio City event highlights with the same slide-based viewing flow"
