    ...
    <section className={`public-container public-section ${className}`}>
      ...
      >
        <div className={centered ? 'mx-auto max-w-3xl' : 'max-w-3xl'}>
          {eyebrow ? (
            <p className="bccc-public-eyebrow">
              {eyebrow}
            </p>
          ) : null}

          <h2 className="bccc-public-heading">
            {title}
          </h2>
...
export function LuxuryPanel({
  ...
  return (
    <div className={`bccc-public-panel ${className}`}>
      {children}
    </div>
  );
}
...
export function LuxuryScroller({
  ...
  return (
    <div className={`bccc-hidden-scrollbar flex snap-x gap-4 overflow-x-auto pb-3 ${className}`}>
      {children}
    </div>
  );
}
